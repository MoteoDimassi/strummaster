...
"[project]/src/core/tuner/TunerCore.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/core/adapters/BrowserApiAdapter.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/core/adapters/TunerAdapter.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$tuner$2f$TunerCore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/core/tuner/TunerCore.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$adapters$2f$BrowserApiAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/core/adapters/BrowserApiAdapter.ts [app-ssr] (ecmascript)");
;
;
...
class WebAudioDataAdapter {
    ...
    constructor(audioApiAdapter){
        this.audioApiAdapter = audioApiAdapter || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$adapters$2f$BrowserApiAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BrowserApiAdapterFactory"].createAudioAdapter();
    }
...
class TunerAdapter {
    ...
    constructor(animationApiAdapter, audioApiAdapter){
        this.tunerCore = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$tuner$2f$TunerCore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TunerCore"]();
        this.audioDataAdapter = new WebAudioDataAdapter(audioApiAdapter);
        this.animationAdapter = new WebAnimationAdapter(animationApiAdapter || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$adapters$2f$BrowserApiAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BrowserApiAdapterFactory"].createAnimationAdapter());
...
"[project]/src/features/tuner/services/TunerService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$adapters$2f$TunerAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/core/adapters/TunerAdapter.ts [app-ssr] (ecmascript)");
;
class TunerService {
    isRunning = false;
    async start() {
        console.log('[TunerService] Запуск тюнера');
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$adapters$2f$TunerAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tunerAdapter"].start();
        this.isRunning = true;
    }
    stop() {
        console.log('[TunerService] Остановка тюнера');
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$adapters$2f$TunerAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tunerAdapter"].stop();
        this.isRunning = false;
    }
    async getPitch() {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$adapters$2f$TunerAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tunerAdapter"].getPitch();
    }
    startContinuousAnalysis(callback) {
        console.log('[TunerService] Запуск непрерывного анализа');
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$adapters$2f$TunerAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tunerAdapter"].startContinuousAnalysis(callback);
    }
    // Методы для прямого использования TunerCore
    analyzeFrequency(frequency) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$adapters$2f$TunerAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tunerAdapter"].analyzeFrequency(frequency);
    }
    analyzeFrequencyForGuitar(frequency) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$adapters$2f$TunerAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tunerAdapter"].analyzeFrequencyForGuitar(frequency);
    }
    getClosestGuitarNote(pitch) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$adapters$2f$TunerAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tunerAdapter"].getClosestGuitarNote(pitch);
    }
    getGuitarNotes() {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$adapters$2f$TunerAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tunerAdapter"].getGuitarNotes();
    }
    frequencyFromNoteNumber(note) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$adapters$2f$TunerAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tunerAdapter"].frequencyFromNoteNumber(note);
    }
    autoCorrelate(buf, sampleRate) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$adapters$2f$TunerAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tunerAdapter"].autoCorrelate(buf, sampleRate);
    }
    isAudioRunning() {
        return this.isRunning;
    }
    // Метод для переключения между режимами анализа
    useTunerCoreAnalysis(useCore) {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$adapters$2f$TunerAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tunerAdapter"].useTunerCoreAnalysis(useCore);
    }
    // Метод для прямого использования TunerService
    startTunerServiceAnalysis(callback) {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$adapters$2f$TunerAdapter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tunerAdapter"].startTunerServiceAnalysis(callback);
    }
}
const tunerService = new TunerService();
}),
"[project]/src/features/tuner/components/TunerDisplay.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/features/tuner/components/TunerControls.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/tuner/TunerClient.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tuner$2f$services$2f$TunerService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/tuner/services/TunerService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tuner$2f$components$2f$TunerDisplay$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/tuner/components/TunerDisplay.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tuner$2f$components$2f$TunerControls$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/tuner/components/TunerControls.tsx [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function TunerPage() {
    ...
    const { isRunning, mode, error, currentNote, currentFrequency, currentDetune, pointerPosition, isInTune } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$hooks$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAppSelector"])((state)=>state.tuner);
    ...
    const startTunerService = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tuner$2f$services$2f$TunerService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tunerService"].start();
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$slices$2f$tunerSlice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["startTuner"])());
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tuner$2f$services$2f$TunerService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tunerService"].startContinuousAnalysis((result)=>{
                if (result) {
                    dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$slices$2f$tunerSlice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateTunerResult"])(result));
                }
            });
        } catch (err) {
            const errorMessage = err instanceof Error ? err.message : 'Failed to start tuner';
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$slices$2f$tunerSlice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setTunerError"])(errorMessage));
        }
    };
    const stopTunerService = ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tuner$2f$services$2f$TunerService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tunerService"].stop();
        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$slices$2f$tunerSlice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["stopTuner"])());
    };
    const handleModeChange = (newMode)=>{
        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$slices$2f$tunerSlice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setTunerMode"])(newMode));
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tuner$2f$components$2f$TunerControls$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TunerControls"], {
                    isRunning: isRunning,
                    mode: mode,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$tuner$2f$components$2f$TunerDisplay$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TunerDisplay"], {
...
//# sourceMappingURL=src_7b02c46e._.js.map